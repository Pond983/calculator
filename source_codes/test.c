...
int test(void) {
	...
	strncpy(formula_buf.formula[0], "1", MAX_DIGIT);
	strncpy(formula_buf.formula[1], "+", MAX_DIGIT);
	strncpy(formula_buf.formula[2], "1", MAX_DIGIT);
	...
	strncpy(formula_buf.formula[0], "1", MAX_DIGIT);
	strncpy(formula_buf.formula[1], "1", MAX_DIGIT);
	strncpy(formula_buf.formula[2], "+", MAX_DIGIT);
	formula_buf.type[0] = NUM;
	...
	strncpy(string_buf, "(1+1) + (2+3)*4", MAX_INPUT_SIZE );
